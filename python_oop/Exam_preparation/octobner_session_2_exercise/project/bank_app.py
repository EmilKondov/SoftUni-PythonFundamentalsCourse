...
class BankApp:
    ...
    def add_client(self, client_type: str, client_name: str, client_id: str, income: float):
        ...
        if not income < self.capacity:
            return "Not enough bank capacity."

        client = self.VALID_CLIENT_TYPES[client_type]()
    ...
    def grant_loan(self, loan_type: str, client_id: str):
        ...
        if not (client.__class__.__name__ == "Student" and loan_type== "StudentLoan") or not (loan_type == "MortgageLoan" and loan_type == "Adult"):
    ...
    def get_statistics(self):
        ...
        granted_sum  = sum([c for c in self.clients])
