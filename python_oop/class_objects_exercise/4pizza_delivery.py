class PizzaDelivery:
    ...
    def add_extra(self, ingredient: str, quantity: int, price_per_quantity: float):
        ...
        """ Below is more efficient way of creating the method add_extra
        if self.ordered:
            return self.get_ordered_message()
        
        self.ingredients[ingredient] = self.ingredients.get(integer, 0) + quantity
    ...
    def make_order(self):
        self.ordered = True
        """
        Key moment in this exercise is to create the ingredients as a string like I have 
        done below using .join method.
